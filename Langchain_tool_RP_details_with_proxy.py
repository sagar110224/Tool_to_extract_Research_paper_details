...
class get_details (extract_valid_proxies):
    def __init__(self):
    ...
    def extract_details_from_page(self,k):
        for i in range(10):
            ...
            try:
                ...
                continue
            if 'books.google' in url.lower() or '.pdf' in url.lower():
                continue
        ...
        try:
            ...
            while len(self.all_paper_details)<=k:
                ...
                try:
                    ...
                    break
            if len(self.all_paper_details)==0:
            ...
            self.driver.quit()
            os.remove(self.plugin_file_path)
...
print(extract_paper_details_tool.invoke({"search_str":"How is AI changing the world","number_of_papers":5}))
